  ...
  theme: {
    ...
    tokens: {
      colors: {
        ...
        textSecondary: AppConfig.theme.colors.textSecondary,
        textInverse: AppConfig.theme.colors.textInverse,
        textPositive: AppConfig.theme.colors.textPositive,
        textNegative: AppConfig.theme.colors.textNegative,
        brandPrimary: AppConfig.theme.colors.primary,
        brandPrimaryHover: AppConfig.theme.colors.primaryHover,
        brandPrimaryPressed: AppConfig.theme.colors.primaryPressed,
        brandPrimaryBackground: AppConfig.theme.colors.primaryBackground,
        brandPrimaryForeground: AppConfig.theme.colors.primaryForeground,
        brandPrimaryForegroundMuted: AppConfig.theme.colors.primaryForegroundMuted,
        brandPrimaryLineHeavy: AppConfig.theme.colors.primaryLineHeavy,
        brandSecondary: AppConfig.theme.colors.secondary,
        brandSecondaryHover: AppConfig.theme.colors.secondaryHover,
        brandSecondaryPressed: AppConfig.theme.colors.secondaryPressed,
        brandSecondaryForeground: AppConfig.theme.colors.secondaryForeground,
        brandDefault: AppConfig.theme.colors.default,
        brandDefaultHover: AppConfig.theme.colors.defaultHover,
        brandDefaultPressed: AppConfig.theme.colors.defaultPressed,
        brandDefaultForeground: AppConfig.theme.colors.defaultForeground,
        brandPositive: AppConfig.theme.colors.textPositive,
        brandNegative: AppConfig.theme.colors.textNegative,
